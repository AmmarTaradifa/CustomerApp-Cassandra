...
exports.list = function(req, res){
	...
	client.execute('SELECT * FROM people.subscribers',[], function(err, result){
		if(err){
			...
			res.render('customers', {page_title:"Customers App", data: result.rows})
		}
	});
...
exports.add = function(req, res){
  res.render('add_customer',{page_title:"Add Customers App"});
};
...
exports.edit = function(req, res){
	...
	client.execute("SELECT * from people.subscribers WHERE id = " + id + " ALLOW FILTERING",[], function(err, result){
		if(err){
			...
			res.render('edit_customer',{page_title:"Edit Customers App", data: result.rows});
		}
	});
